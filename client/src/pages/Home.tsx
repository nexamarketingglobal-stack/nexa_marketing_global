    ...
    >
      ...
      <footer className="bg-[#F7F5F2]">
        <div className="container grid gap-10 py-12 sm:grid-cols-[1.3fr_repeat(3,0.7fr)]">
          ...
          <div><p className="text-[11px] font-extrabold uppercase tracking-[0.16em] text-[#C9141B]">{content.footer.legal}</p><a href={`/privacy?lang=${language}`} className="mt-4 block text-sm font-bold transition-colors hover:text-[#C9141B]">{content.footer.privacy}</a><a href={`/terms?lang=${language}`} className="mt-3 block text-sm font-bold transition-colors hover:text-[#C9141B]">{content.footer.terms}</a><a href={`/cookies?lang=${language}`} className="mt-3 block text-sm font-bold transition-colors hover:text-[#C9141B]">{content.footer.cookies}</a></div>
        </div>
